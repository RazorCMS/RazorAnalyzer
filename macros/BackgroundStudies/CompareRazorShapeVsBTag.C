...
void PlotTwoBTagVsThreeBTagShapes() {
  ...
  histMR_Multijet_TwoBTag->Draw("e1");
  histMR_Multijet_ThreeBTag->Draw("e1same");

  histMR_Multijet_TwoBTag->GetYaxis()->SetTitleOffset(1.2);
  ...
  histMR_MuonMultijet_TwoBTag->Draw("e1");
  histMR_MuonMultijet_ThreeBTag->Draw("e1same");

  histMR_MuonMultijet_TwoBTag->GetYaxis()->SetTitleOffset(1.2);
  ...
  histMR_ElectronMultijet_TwoBTag->Draw("e1");
  histMR_ElectronMultijet_ThreeBTag->Draw("e1same");

  histMR_ElectronMultijet_TwoBTag->GetYaxis()->SetTitleOffset(1.2);
