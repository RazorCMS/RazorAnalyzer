...
void RunSelectWJetsSingleLeptonControlSample( vector<string> datafiles, vector<vector<string> > bkgfiles, vector<string> bkgLabels, 
 ...
 TFile *NVtxWeightFile = new TFile("/afs/cern.ch/work/s/sixie/public/releases/run2/CMSSW_7_4_2/src/RazorAnalyzer/data/NVtxReweight_ZToMuMu_2015D_25ns.root", "READ");
  ...
  for (uint i=0; i < inputfiles.size(); ++i) {
    ...
    histHT.push_back(new TH1D(Form("histHT_%s",processLabels[i].c_str()), "; H_{T} [GeV/c^{2}]; Number of Events", 40, 400, 2400));
  ...
  for (uint i=0; i < inputfiles.size(); ++i) {
	...
	if (processLabels[i] == "WJets") weight = weight * 1.1;
	...
	// if (!isData && processLabels[i] == "WJets" ) {
	//   //met = corrMet;
	...
	if (! (fabs(events->lep1.Eta()) < 1.5) ) continue;
...
void SelectWJetsControlSample( int option = -1) {
  ...
  if (option == 1 || option == 11 || option == 12 || option == 101 || option == 102) {
    datafiles.push_back("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull/RunTwoRazorControlRegions_OneLeptonFull_SingleMuon_Run2015D_GoodLumi.root");
  } 
  if (option == 0 || option == 10 || option == 12 || option == 100 || option == 102) {
    datafiles.push_back("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull/RunTwoRazorControlRegions_OneLeptonFull_SingleElectron_Run2015D_GoodLumi.root");
  }
  ...
  if (option == 1 || option == 11 || option == 101) {
    bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_MuEnriched_1pb_weighted.root");
  }
  if (option == 0 || option == 10 || option == 100) {
    bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_EMEnriched_1pb_weighted.root");
  }
  ...
  //*********************************************************************
  if (option == 0) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"MR300Rsq0p15_ZeroMediumBTag",0,"MR300Rsq0p15_ZeroMediumBTag_SingleEle");
  }
  if (option == 10) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"MR300Rsq0p15_ZeroLooseBTag",0,"MR300Rsq0p15_ZeroLooseBTag_SingleEle");
  }
  if (option == 100) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"Inclusive",0,"Inclusive_SingleEle");
  }
  ...
  //*********************************************************************
  if (option == 1) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"MR300Rsq0p15_ZeroMediumBTag",1,"MR300Rsq0p15_ZeroMediumBTag_SingleMu");
  }
  if (option == 11) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"MR300Rsq0p15_ZeroLooseBTag",1,"MR300Rsq0p15_ZeroLooseBTag_SingleMu");
  }
  if (option == 101) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"Inclusive",1,"Inclusive_SingleMu");
  }
  ...
  //*********************************************************************
  if (option == 12) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"MR300Rsq0p15_ZeroMediumBTag",-1,"MR300Rsq0p15_ZeroMediumBTag_All");
  }
  if (option == 102) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, 157,"Inclusive",-1,"Inclusive_All");
  }
