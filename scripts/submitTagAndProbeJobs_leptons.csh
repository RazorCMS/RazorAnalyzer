...
SingleMuon_2016E_PRv2 \
  ...
  set inputfilelist="/afs/cern.ch/work/j/jmao/RAZORRUN2/CMSSW_7_4_7/src/RazorAnalyzer/lists/Run2/razorNtuplerV3p5/data/${sample}.cern.txt"
  set filesPerJob = 1
  ...
  foreach jobnumber(`seq 0 1 $maxjob`)
	...
	bsub -q 8nm -o /afs/cern.ch/work/j/jmao/RAZORRUN2/CMSSW_7_4_7/src/RazorAnalyzer/submission/MuTrigger/TagAndProbe_MuTrigger_${sample}_${jobnumber}.out -J TagAndProbe_MuTrigger_${sample}_${jobnumber} /afs/cern.ch/work/j/jmao/RAZORRUN2/CMSSW_7_4_7/src/RazorAnalyzer/scripts/runRazorJob_CERN_EOS_Jiajing.csh RazorTagAndProbe $inputfilelist true 20560 $filesPerJob $jobnumber TagAndProbe_MuTrigger_${sample}.Job${jobnumber}Of${maxjob}.root /store/group/phys_susy/razor/Run2Analysis/TagAndProbe_ICHEP2016/MuTrigger/jobs/
...
#)
#  setenv LSB_JOB_REPORT_MAIL N
#  set inputfilelist="/afs/cern.ch/work/j/jmao/RAZORRUN2/CMSSW_7_4_7/src/RazorAnalyzer/lists/Run2/razorNtuplerV3p5/MC/25ns/${sample}.cern.txt"
#  set filesPerJob = 1
#  set nfiles = `cat $inputfilelist | wc | awk '{print $1}' `
#  set maxjob=`python -c "print int($nfiles.0/$filesPerJob)-1"`
#  echo "Sample " $sample " maxjob = " $maxjob
...
DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8\
  ...
  setenv LSB_JOB_REPORT_MAIL N
  set inputfilelist="/afs/cern.ch/work/j/jmao/RAZORRUN2/CMSSW_7_4_7/src/RazorAnalyzer/lists/Run2/razorNtuplerV3p2/MC/${sample}.cern.txt"
  set filesPerJob = 1
  set nfiles = `cat $inputfilelist | wc | awk '{print $1}' `
  set maxjob=`python -c "print int($nfiles.0/$filesPerJob)-1"`
  echo "Sample " $sample " maxjob = " $maxjob
